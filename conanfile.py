...
class QuariumController(ConanFile):
    ...
    requires = "spdlog/0.17.0@bincrafters/stable", "catch2/2.3.0@bincrafters/stable", "fmt/4.1.0@bincrafters/stable", "jsonformoderncpp/3.1.2@vthiery/stable", "clara@1.1.4@bincrafters/stable", "boost_beast@1.66.0@bincrafters/stable", "wpa_ctrlpp/1.0@user/stable", "libgpiod/1.1.1-2@user/stable", "lvgl_cmake/5.1.1-3@user/stable"
